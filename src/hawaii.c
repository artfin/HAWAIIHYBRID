...
void p_generator_flux(MoleculeSystem *ms, double Temperature)
/**
...
double analytic_full_partition_function_by_V(MoleculeSystem *ms, double Temperature)
{
   ...
   // printf("MONOMER TYPES TEST %d %d",ms->m1.t, ROTOR);
 ...
 */  
{
    ...
    double tmax = sampling_time * (a.n - 1);
    
    double i0_beta = gsl_sf_bessel_I0(beta); 
