...
int main(int argc, char *argv[])
{
    ...
    params.partial_partition_function_ratios[0]  = 2.68029e+05; // 4.52775e+05; // F, 370 K
    params.partial_partition_function_ratios[0]  = 2.68097e+05; // 4.22907e+05; // F, 360 K
    params.partial_partition_function_ratios[0]  = 2.68095e+05; // 3.94145e+05; // F, 350 K
    params.partial_partition_function_ratios[0]  = 2.68166e+05; // 3.66689e+05; // F, 340 K
    params.partial_partition_function_ratios[0]  = 2.68150e+05; // 3.40299e+05; // F, 330 K
    params.partial_partition_function_ratios[0]  = 2.68244e+05; // 3.15211e+05; // F, 320 K
    params.partial_partition_function_ratios[0]  = 2.68219e+05; // 2.91132e+05; // F, 310 K
    */
    params.partial_partition_function_ratios[0]  = 2.68234e+05; // F, 300 K
    params.partial_partition_function_ratios[1]  = 2.68307e+05; // 2.46503e+05; // F, 290 K
    params.partial_partition_function_ratios[2]  = 2.68286e+05; // 2.25782e+05; // F, 280 K
    params.partial_partition_function_ratios[3]  = 2.68408e+05; // 2.06254e+05; // F, 270 K
    params.partial_partition_function_ratios[4]  = 2.68455e+05; // 1.87716e+05; // F, 260 K
    params.partial_partition_function_ratios[5]  = 2.68456e+05; // 1.70185e+05; // F, 250 K
    params.partial_partition_function_ratios[6]  = 2.68496e+05; // 1.53696e+05; // F, 240 K
    params.partial_partition_function_ratios[7]  = 2.68582e+05; // 1.38227e+05; // F, 230 K
    params.partial_partition_function_ratios[8]  = 2.68659e+05; // 1.23724e+05; // F, 220 K
    params.partial_partition_function_ratios[9]  = 2.68785e+05; // 1.10192e+05; // F, 210 K
    params.partial_partition_function_ratios[10] = 2.68893e+05; // 9.75779e+04; // F, 200 K
    /*                                                               
    params.partial_partition_function_ratios[11] = 2.69040e+05; // 8.58810e+04; // F, 190 K 
    params.partial_partition_function_ratios[11] = 2.69078e+05; // 7.50338e+04; // F, 180 K 
    params.partial_partition_function_ratios[12] = 2.69266e+05; // 6.50880e+04; // F, 170 K 
    params.partial_partition_function_ratios[13] = 2.69405e+05; // 5.59632e+04; // F, 160 K 
    params.partial_partition_function_ratios[14] = 2.69600e+05; // 4.76590e+04; // F, 150 K 
    params.partial_partition_function_ratios[15] = 2.69773e+05; // 4.01343e+04; // F, 140 K 
    params.partial_partition_function_ratios[16] = 2.69958e+05; // 3.33696e+04; // F, 130 K 
    params.partial_partition_function_ratios[17] = 2.70302e+05; // 2.73527e+04; // F, 120 K 
    params.partial_partition_function_ratios[18] = 2.70594e+05; // 2.20291e+04; // F, 110 K 
    params.partial_partition_function_ratios[19] = 2.70950e+05; // 1.73815e+04; // F, 100 K
    params.partial_partition_function_ratios[19] = 2.72888e+05; // 1.33802e+04; // F, 90 K
    params.partial_partition_function_ratios[19] = 2.72051e+05; // 9.99014e+03; // F, 80 K
    params.partial_partition_function_ratios[19] = 2.71430e+05; // 7.17673e+03; // F, 70 K
    */
