...
int main(int argc, char *argv[])
{
    ...
    double MU = m_D2 * m_Ar / (m_D2 + m_Ar); 
    double I1[2] = {II_D2, II_D2};
    ...
    params.ortho_state_weight               = 1.0/3.0; 
    params.para_state_weight                = 2.0/3.0; 
    
    double Temperature = 164.0;

    String_Builder sf_filename = {};
    sb_append_format(&sf_filename, "./SF-PRMU-D2-Ar-%.1f.txt", Temperature); 
