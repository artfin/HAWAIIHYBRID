...
int main(int argc, char *argv[])
{
    ...
    //params.partial_partition_function_ratios[1]  = 2.68695e+05; // F, 390 K
    //params.partial_partition_function_ratios[2]  = 2.68634e+05; // F, 380 K
    //params.partial_partition_function_ratios[3]  = 2.68936e+05; // F, 370 K
    //params.partial_partition_function_ratios[4]  = 2.68990e+05; // F, 360 K
    //params.partial_partition_function_ratios[5]  = 2.69024e+05; // F, 350 K
    //params.partial_partition_function_ratios[6]  = 2.69049e+05; // F, 340 K
    //params.partial_partition_function_ratios[7]  = 2.69026e+05; // F, 330 K
    //params.partial_partition_function_ratios[8]  = 2.69329e+05; // F, 320 K
    //params.partial_partition_function_ratios[9]  = 2.69332e+05; // F, 310 K
    //params.partial_partition_function_ratios[0]  = 2.69423e+05; // F, 300 K
    //params.partial_partition_function_ratios[1]  = 2.69477e+05; // F, 290 K
    //params.partial_partition_function_ratios[2]  = 2.69618e+05; // F, 280 K
    //params.partial_partition_function_ratios[3]  = 2.69842e+05; // F, 270 K
    //params.partial_partition_function_ratios[4]  = 2.69944e+05; // F, 260 K
    //params.partial_partition_function_ratios[5]  = 2.70007e+05; // F, 250 K
    //params.partial_partition_function_ratios[6]  = 2.70329e+05; // F, 240 K
    ...
    //params.partial_partition_function_ratios[9]  = 1.17825e+02; // B, 210 K
    //params.partial_partition_function_ratios[10] = 1.45652e+02; // B, 200 K
    //params.partial_partition_function_ratios[11] = 1.82218e+02; // B, 190 K
    //params.partial_partition_function_ratios[12] = 2.32009e+02; // B, 180 K
    //params.partial_partition_function_ratios[13] = 2.99301e+02; // B, 170 K
    //params.partial_partition_function_ratios[14] = 3.93201e+02; // B, 160 K
    //params.partial_partition_function_ratios[15] = 5.26234e+02; // B, 150 K
    //params.partial_partition_function_ratios[16] = 7.22653e+02; // B, 140 K
    //params.partial_partition_function_ratios[17] = 1.01798e+03; // B, 130 K
    //params.partial_partition_function_ratios[18] = 1.48991e+03; // B, 120 K
    //params.partial_partition_function_ratios[19] = 2.26753e+03; // B, 110 K
