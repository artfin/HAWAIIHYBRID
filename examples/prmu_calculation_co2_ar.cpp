...
int main(int argc, char *argv[])
{
    ...
    params.sampler_Rmin            = 4.0;  // TODO: q_generator uses these fields here although they do not make sense 
    params.sampler_Rmax            = 40.0; // TODO: q_generator uses these fields here although they do not make sense 
    params.niterations             = 10;
    params.total_trajectories      = 5000;
