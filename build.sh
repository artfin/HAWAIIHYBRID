...
$CXX $FLAGS $INC_SUNDIALS $INC_EIGEN -I./ -I./PES-IDS/ $SAMPLING_OBJ ./examples/phase_space_integration_co2_ar.c -o ./examples/phase_space_integration_co2_ar.exe -lm $LIB_SUNDIALS -lgsl -lgslcblas -lstdc++  
$CXX $FLAGS $INC_SUNDIALS $INC_EIGEN -I./ -I./PES-IDS/ ./examples/trajectory_co2_ar.c ./build/ai_pes_co2ar.o ./build/hawaii.o ./build/mtwist.o ./build/angles_handler.o ./build/trajectory.o ./build/array.o -o ./examples/trajectory_co2_ar.exe -lm $LIB_SUNDIALS -lgsl -lgslcblas -lstdc++  
