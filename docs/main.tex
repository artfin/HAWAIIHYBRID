...
\begin{longtable}{lp{15cm}}
    ...
    Description & Requantizes a given value of the angular momentum to the nearest integer, effectively rounding to the closest whole number (0, 1, 2, 3 ...). Note that the value returned as double-precision value.
\end{longtable} 
